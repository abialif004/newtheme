...
function testbyte_register_style()
{
    ...
    $root_path = get_template_directory_uri();
    wp_enqueue_style('main-stylesheet', $root_path . '/assets/css/main.css', array('bootstrap-stylesheet'), $version, 'all');
    ...
    wp_enqueue_style('responsive-stylesheet-phone', $root_path . '/assets/css/mobile_mediaquery.css', array('bootstrap-stylesheet'), false, 'all');
    wp_enqueue_style('responsive-stylesheet-tablet', $root_path . '/assets/css/tablet_mediaquery.css', array('bootstrap-stylesheet'), false, 'all');
    wp_enqueue_style('responsive-stylesheet-desktop', $root_path . '/assets/css/desktop_mediaquery.css', array('bootstrap-stylesheet'), false, 'all');
}
...
{
    $root_path = get_template_directory_uri();
    wp_enqueue_script('bootstrap-script', $root_path . '/assets/js/bootstrap.min.js', array(), '4.0', false);
    wp_enqueue_script('fontawsome-script', 'https://kit.fontawesome.com/c98653d00b.js', array(), false, false);
    wp_enqueue_script('main-script', $root_path . '/assets/js/script.js', array(), '1.0', true);
